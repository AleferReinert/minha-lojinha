...
import { calculateParcel, formatPrice } from '../../components/Global';
    ...
    return (
        <>
            ...
            <div className='container grid'>
                ...
                <RatingStars rating={product.rating} device='mobile' />
                <ImagesCarousel images={product.images} />
                <div className='product-info'>
                    <ProductTitle device='desktop' />
                    <RatingStars rating={product.rating} device='desktop' />
                    <p id='price-row'>
